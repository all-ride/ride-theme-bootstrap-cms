{* widget: google.tags action: index; translation: widget.google.tags *}
<noscript>
    <iframe src="//www.googletagmanager.com/ns.html?id={$code}" height="0" width="0" style="display:none;visibility:hidden"></iframe>
</noscript>
